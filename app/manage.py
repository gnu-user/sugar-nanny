...
from nanny.app import create_app
from nanny.database import db
from nanny.settings import DevConfig, ProdConfig
from nanny.user.models import User

CONFIG = ProdConfig if os.environ.get('NANNY_ENV') == 'prod' else DevConfig
